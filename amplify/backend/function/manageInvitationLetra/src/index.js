/* Amplify Params - DO NOT EDIT
  ...
  API_DR ConferenceAIGRAPHQL_TEAMINVITATIONTABLE_ARN
  API_DR ConferenceAIGRAPHQL_TEAMINVITATIONTABLE_NAME
  API_DR ConferenceAIGRAPHQL_TEAMTABLE_ARN
...
exports.handler = async (event) => {
  ...
  const TEAM_TABLE = API_DR ConferenceAIGRAPHQL_TEAMTABLE_NAME;
  const TEAM_INVITATION_TABLE = API_DR ConferenceAIGRAPHQL_TEAMINVITATIONTABLE_NAME;
