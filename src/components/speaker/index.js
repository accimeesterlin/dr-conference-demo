      ...
      <div className="row">
        <div className="container">
          <div className="row spe_wrapper">
            <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 wow zoomIn" data-wow-delay=".2s">
              <div className="single-speaker first">
                ...
                <div className="cont-box text-center">
                  <div>
                    <a href="schedule-single.html">
                      <h4>Jhon Michelle</h4>
                    </a>
                    <h5>web developer</h5>
                    <div className="social-icons text-center">
                      <a href="#"> <span className="si3"><i className="fab fa-pinterest-p"></i>
                      </span></a>
                      <a href="#"> <span className="si1"><i className="fab fa-facebook-f"></i> </span>
                      </a>
                      <a href="#"> <span className="si3"> <i
                        className="fab fa-linkedin-in"></i></span></a>
            ...
            <a href="speakers.html" className="btn1 wow fadeInUp">see more</a>
          </div>
        </div>
      </div>
    </div>
